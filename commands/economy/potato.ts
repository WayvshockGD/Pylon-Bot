      ...
      await message.reply(
        new discord.Embed({
          ...
          description: [
            ...
            '',
            '**commands**:',
            '- `[p]potato help` - shows this help message',
            '- `[p]potato` - show off your potato balance',
            '- `[p]potato inspect [user]` - inspect another [user]s potato balance',
            '- `[p]potato top [count]` - top n potato collectors',
            '- `[p]potato gamble <count>` - gamble <count> potatos',
            '- `[p]potato steal <who> <count>` - steal potatos from other people',
            "- `[p]potato give <who> <count>` - give your potatos to other people - if you're feeling kind.",
            '- `[p]potato drop` - drop one of your potatos. the fastest to pick it up gets it',
            '- `[p]potato daily` - claim your daily potato',
            '',
            '- `[p]potato lottery` - info about the current lottery pool',
            '- `[p]potato lottery deposit <count>` - deposit <count> potatos into the lottery pool',
            '',
            '- `[p]potato shop list` - list all available shop items',
            '- `[p]potato shop buy <item>` - buy <item> from the shop'
          ].join('\n')
        })
      );
    }
